...
var imageData = {};
var imageDataKeys = [];
selectedBrands = 'Campbells|Progresso|Cup';
...
function loadData() {
  get('brand_counts.json', function(data) {
    ...
    brandCounts = [
    {x: "Campbell's", value: brandCountsHolder["Campbells"]},
    {x: "Progresso", value: brandCountsHolder["Progresso"]},
    {x: "Cup Noodles", value: brandCountsHolder["Cup"]}
];
  })    
...
function addWindowEventListeners() {
  ...
  window.addEventListener('hashchange', function(e) {
    ...
    marker.XPos = (((coords.x + 11840)/(13080 + 11840)) * 300) - (marker.Width / 2);
    marker.YPos = (193 - ((coords.y + 4960)/(5888 + 4960)) * 193) - marker.Height;
    ...
    clusterCounts = [
    {x: "Campbell's", value: thisClusterData["Campbells"]},
    {x: "Progresso", value: thisClusterData["Progresso"]},
    {x: "Cup Noodles", value: thisClusterData["Cup"]}
    ]
...
mapSprite.src = "assets/images/Campbells Full Map.png";
